...
HIGH_RISK_API_POLICIES: tuple[ApiGovernancePolicy, ...] = (
    ...
    local_policy("POST", "/api/v1/ssh/host-key/scan", "ssh.host_key.scan", "server", "platform-admin"),
    ...
    local_policy("POST", "/api/v1/servers/{server_id}/runner/diagnostics/repair", "remote_runner.diagnostics_repair", "server", "platform-admin"),
    ...
    local_policy("GET", "/api/v1/servers/{server_id}/listening-ports", "diagnostics.listening_ports.read", "server", "auditor"),
    ...
    remote_policy(
        ...
        "apps/remote_runner/execution_lifecycle_routes.py",
        "execution.lifecycle_guard",
        "execution_lifecycle",
        "implemented",
        "platform-admin",
    ),
    remote_policy(
        ...
        "apps/remote_runner/execution_lifecycle_routes.py",
        "execution.lifecycle_guard.release",
        "execution_lifecycle",
        "implemented",
        "platform-admin",
    ),
    ...
    *(remote_policy(*spec) for spec in ARTIFACT_LIFECYCLE_POLICY_GOVERNANCE_SPECS),
    remote_policy(
        ...
        "apps/remote_runner/execution_query_routes.py",
        "artifact.storage_readiness.read",
    ...
    remote_policy(
        ...
        "apps/remote_runner/execution_query_routes.py",
        "artifact.storage_readiness.smoke",
        "artifact_storage_readiness",
        "implemented",
        "artifact-curator",
        "platform-admin",
    ...
    remote_policy(
        ...
        "workflow_trigger_readiness_watcher",
        "implemented",
        "workflow-operator",
    ),
    remote_policy(
