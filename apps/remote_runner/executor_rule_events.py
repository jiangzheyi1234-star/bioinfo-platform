...
from .snakemake_rule_event_projection import project_snakemake_rule_events
...
def run_snakemake_with_rule_events(
    ...
    *,
    ...
    projection = project_snakemake_rule_events(
        cfg,
        run_id=run_id,
        ...
        event_log_path=event_log_path,
        workflow_succeeded=result.returncode == 0,
    )
