...
def migrate_runtime_schema(connection: sqlite3.Connection) -> None:
    ...
    try:
        ...
        _record_migration(connection, CURRENT_SCHEMA_VERSION, RESULT_PACKAGE_RETIRED_AT_MIGRATION_NAME)
...
def _baseline_checksum() -> str:
    payload = (
        f"{CURRENT_SCHEMA_VERSION}:{RESULT_PACKAGE_RETIRED_AT_MIGRATION_NAME}:"
