...
from .agent_process_current_schema import AGENT_PROCESS_CURRENT_SCHEMA_SQL
...
""" + AGENT_SESSION_SCHEMA_SQL + AGENT_WORKSPACE_PROOF_SCHEMA_SQL + AGENT_PROCESS_CURRENT_SCHEMA_SQL + ARTIFACT_CACHE_PIN_SCHEMA_SQL + ARTIFACT_LIFECYCLE_POLICY_SCHEMA_SQL + WORKFLOW_TRIGGER_READINESS_WATCHER_SCHEMA_SQL
