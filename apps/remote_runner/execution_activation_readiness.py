    ...
    *,
    ...
    return _readiness(
        ...
        summary={
            ...
            "declaredOutputCount": _safe_int(output_closure.get("declaredOutputCount")),
            "verifiedDeclaredOutputCount": _safe_int(output_closure.get("verifiedDeclaredOutputCount")),
            "adoptedDeclaredOutputCount": _safe_int(output_closure.get("adoptedDeclaredOutputCount")),
