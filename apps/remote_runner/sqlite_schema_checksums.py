...
def runtime_schema_ledger_checksum(version: int, name: str) -> str:
    ...
    if (normalized_version, normalized_name) == (
        V21_SCHEMA_VERSION,
    ...
    elif (normalized_version, normalized_name) != (
        V22_SCHEMA_VERSION,
        V22_SCHEMA_MIGRATION_NAME,
    ):
        normalized_version = V22_SCHEMA_VERSION
        normalized_name = V22_SCHEMA_MIGRATION_NAME
    payload = (
