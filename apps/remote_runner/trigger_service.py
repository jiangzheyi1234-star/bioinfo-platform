...
LAUNCH_SUPPORTED_TRIGGER_SOURCES = {"manual"}
READINESS_TRIGGER_SOURCES = {"dataset", "file", "database_ready"}
SCHEDULER_TRIGGER_SOURCES = {"cron"}
ENABLED_TRIGGER_SOURCES = LAUNCH_SUPPORTED_TRIGGER_SOURCES | SCHEDULER_TRIGGER_SOURCES | READINESS_TRIGGER_SOURCES | {
    "backfill",
    "webhook",
}
