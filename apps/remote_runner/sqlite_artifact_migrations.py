...
def ensure_artifact_cache_pins(connection: sqlite3.Connection) -> None:
    connection.execute(
        """
...
def ensure_result_package_export_payload_mode(connection: sqlite3.Connection) -> None:
    _ensure_columns(
        connection,
...
def ensure_result_package_export_byte_state(connection: sqlite3.Connection) -> None:
    _ensure_columns(
        connection,
        "result_package_exports",
        {
...
def migrate_artifact_cache_pin_schema(
    connection: sqlite3.Connection,
    *,
    record_migration: RecordMigration,
    version: int,
...
def migrate_result_package_payload_mode_schema(
    connection: sqlite3.Connection,
    *,
    record_migration: RecordMigration,
    version: int,
...
def migrate_result_package_byte_state_schema(
    connection: sqlite3.Connection,
    *,
    record_migration: RecordMigration,
    version: int,
