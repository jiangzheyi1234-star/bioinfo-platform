        ...
        ToolProfile(
            ...
            rule_template={
                ...
                "params": {
                    "extra": {
                        "type": "string",
                        "title": "Extra fastp arguments",
                        "default": "",
                    },
                    "adapters": {
                        "type": "string",
                        "title": "Adapter arguments",
                        "default": "",
                    },
                },
...
TOOL_PROFILES: tuple[ToolProfile, ...] = load_bio_tool_pack_manifest(
    DEFAULT_BIO_TOOL_PACK_MANIFEST
)
