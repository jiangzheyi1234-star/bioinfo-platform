...
def test_generated_workflow_uses_registered_rule_template_and_preserves_rule_spec_draft(tmp_path: Path) -> None:
    ...
    prepare_generated_tool_workflow(
        ...
        run_spec=generated_workflow_run_spec("conda-forge::draft-rule", input_name="reads"),
...
def test_generated_workflow_rejects_rule_spec_draft_requiring_user_completion(tmp_path: Path) -> None:
    ...
    try:
        prepare_generated_tool_workflow(
            ...
            run_spec=generated_workflow_run_spec("conda-forge::unconfirmed-draft", input_name="reads"),
            resolved_inputs=_input(tmp_path),
            work_dir=tmp_path / "work",
            result_dir=tmp_path / "results",
        )
...
def test_generated_workflow_renders_snakemake_module_use_rule(tmp_path: Path) -> None:
    ...
    prepare_generated_tool_workflow(
        ...
        run_spec=generated_workflow_run_spec("conda-forge::module-count", input_name="reads"),
        resolved_inputs=_input(tmp_path),
        work_dir=tmp_path / "work",
        result_dir=tmp_path / "results",
    )
...
def test_generated_workflow_provenance_follows_executed_rule_template(tmp_path: Path) -> None:
    ...
    prepare_generated_tool_workflow(
        ...
        run_spec=generated_workflow_run_spec("conda-forge::stored-rule", input_name="reads"),
        resolved_inputs=_input(tmp_path),
        work_dir=tmp_path / "work",
        result_dir=tmp_path / "results",
    )
...
def test_generated_workflow_wrapper_provenance_distinguishes_declared_dependency(tmp_path: Path) -> None:
    ...
    prepare_generated_tool_workflow(
        ...
        run_spec=generated_workflow_run_spec("bioconda::wrapper-without-package-lock", input_name="reads"),
        resolved_inputs=_input(tmp_path),
        work_dir=tmp_path / "work",
        result_dir=tmp_path / "results",
    )
