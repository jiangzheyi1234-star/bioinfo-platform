...
def test_remote_runner_execution_proxy_exposes_failure_locator_path() -> None:
    ...
    assert "def prepare_rule_cache_restore_adoption(self, run_id: str, payload: dict[str, Any])" in client_source
    assert "def apply_rule_cache_restore_adoption(self, run_id: str, payload: dict[str, Any])" in client_source
