...
def test_run_result_routes_delegate_runtime_calls_to_service() -> None:
    ...
    assert "prepare_rule_cache_restore_adoption_from_request" in detail_routes
    assert "apply_rule_cache_restore_adoption_from_request" in detail_routes
    ...
    assert "get_run_attempts_from_request" in detail_routes
    ...
    assert "get_run_failure_locator_from_request" in detail_routes
    ...
    assert "def prepare_rule_cache_restore_adoption_from_request(" in service_source
    assert "def apply_rule_cache_restore_adoption_from_request(" in service_source
    ...
    assert "def get_run_attempts_from_request(" in service_source
    ...
    assert "def get_run_failure_locator_from_request(" in service_source
    ...
    assert "runtime_service().prepare_rule_cache_restore_adoption(" in service_source
    assert "runtime_service().apply_rule_cache_restore_adoption(" in service_source
...
def test_workflow_trigger_routes_delegate_runtime_calls_to_service() -> None:
    ...
    assert "get_workflow_trigger_readiness_observation_from_request" in route_source
    ...
    assert "runtime_service().get_workflow_trigger_readiness_observation(" in service_source
