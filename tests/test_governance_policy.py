    ...
    sources.update(
        {
            ...
            ROOT / "apps" / "remote_runner" / "artifact_lifecycle_policy_route_service.py",
            ...
            ROOT / "apps" / "remote_runner" / "artifact_storage_readiness.py",
            ...
            ROOT / "apps" / "remote_runner" / "result_package_byte_gc_run_service.py",
            ...
            ROOT / "apps" / "remote_runner" / "run_failure_locator_read_model.py",
            ...
            ROOT / "apps" / "remote_runner" / "trigger_readiness_watcher_control.py",
            ROOT / "apps" / "remote_runner" / "trigger_readiness_watcher_control_route_service.py",
...
def test_server_scoped_runner_diagnostic_routes_are_governed() -> None:
    ...
    assert (
        "POST",
        "/api/v1/servers/{server_id}/runner/diagnostics/repair",
        "remote_runner.diagnostics_repair",
    ) in policies
