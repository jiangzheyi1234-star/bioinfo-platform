...
def test_run_observability_routes_record_safe_allow_audit(tmp_path, monkeypatch) -> None:
            ...
            "ruleCacheRestorePlan": {
                ...
                "ruleRetryExecutionPlan": {
                    ...
                    "partialRerunOutputClosure": {
                        ...
                        "pendingScopedOutputCount": 1,
                        "declaredOutputCount": 2,
                        "verifiedDeclaredOutputCount": 2,
    ...
    assert list_governance_audit_events(cfg, action="run.execution_context.read")["items"][-1]["details"] == {
        ...
        "ruleRetryActivationBlockedCount": 9,
        "ruleRetryActivationMutationEnabled": False,
        "ruleRetryExecutorContractReady": False,
        "ruleRetryExecutorReady": False,
        "ruleRetryExecutorQueueMutationAllowed": False,
        "ruleRetryExecutorRunStateMutationAllowed": False,
        "ruleRetryExecutorPathsExposed": False,
        "ruleRetryExecutorStorageUrisExposed": False,
        "ruleRetryLaunchPreflightReady": False,
        "ruleRetryLaunchReady": False,
        "ruleRetryLaunchPreflightMode": "",
        "ruleRetryLaunchPreflightScopeOutputCount": 0,
        "ruleRetryLaunchPreflightPlanHashRevalidationRequired": False,
        "ruleRetryLaunchPreflightOutputScopeRevalidationRequired": False,
        "ruleRetryLaunchPreflightTargetAttemptPresent": False,
        "ruleRetryLaunchPreflightActiveLeasePresent": False,
        "ruleRetryLaunchPreflightExecutorStartAllowed": False,
        "ruleRetryLaunchPreflightQueueMutationAllowed": False,
        "ruleRetryLaunchPreflightRunStateMutationAllowed": False,
        "ruleRetryLaunchPreflightPathsExposed": False,
        "ruleRetryLaunchPreflightStorageUrisExposed": False,
        "ruleRetryExecutionBoundaryReady": False,
        "ruleRetryExecutionBoundaryExplicitTargetCount": 0,
        "ruleRetryExecutionBoundaryScopedOutputCount": 0,
        "ruleRetryExecutionBoundaryFinalizeAllowed": False,
        "ruleRetryExecutionBoundaryFinalizeWouldCompleteRun": False,
        "ruleRetryExecutionBoundaryExecutorStartAllowed": False,
        "ruleRetryExecutionBoundaryQueueMutationAllowed": False,
        "ruleRetryExecutionBoundaryRunStateMutationAllowed": False,
        "ruleRetryExecutionBoundaryPathsExposed": False,
        "ruleRetryExecutionBoundaryStorageUrisExposed": False,
        "ruleRetryOutputAuditVerifiedCount": 0,
        "ruleRetryOutputAuditRerunRequiredCount": 0,
        "ruleRetryOutputAuditAdoptedCount": 0,
        "ruleRetryOutputAuditUnverifiedCount": 0,
        "ruleRetryOutputAuditPathsExposed": False,
        "ruleRetryOutputAuditStorageUrisExposed": False,
        "ruleRetryLifecycleContractReady": False,
        "ruleRetryLifecycleMutationReady": False,
        "ruleRetryLifecycleMode": "active-attempt-repair",
        "ruleRetryLifecycleSourceAttemptPresent": True,
        "ruleRetryLifecycleSourceLeaseReleased": False,
        "ruleRetryLifecycleTargetAttemptRequired": True,
        "ruleRetryLifecycleQueueMutationAllowed": False,
        "ruleRetryLifecycleRunStateMutationAllowed": False,
        "ruleRetryLifecyclePathsExposed": False,
        "ruleRetryLifecycleStorageUrisExposed": False,
        "ruleRetryOutputClosureReady": False,
        "ruleRetryOutputClosureEdgeReady": False,
        "ruleRetryOutputClosureScopedCount": 2,
        "ruleRetryOutputClosureAdoptedScopedCount": 1,
        "ruleRetryOutputClosurePendingScopedCount": 1,
        "ruleRetryOutputClosureDeclaredCount": 2,
        "ruleRetryOutputClosureVerifiedDeclaredCount": 2,
        "ruleRetryOutputClosureAdoptedDeclaredCount": 1,
        "ruleRetryOutputClosureAllDeclaredVerified": False,
        "ruleRetryOutputClosurePreservedEdgeCount": 1,
        "ruleRetryOutputClosureMissingPreservedCount": 0,
        "ruleRetryOutputClosureUnknownActiveCount": 0,
        "ruleRetryOutputClosureFinalizeAllowed": False,
        "ruleRetryOutputClosurePathsExposed": False,
        "ruleRetryOutputClosureStorageUrisExposed": False,
        "resumeActivationReady": False,
        "resumeActivationBlockedCount": 4,
        "resumeActivationMutationEnabled": False,
        "resumeExecutorContractReady": False,
        "resumeExecutorReady": False,
        "resumeExecutorQueueMutationAllowed": False,
        "resumeExecutorRunStateMutationAllowed": False,
        "resumeExecutorPathsExposed": False,
        "resumeExecutorStorageUrisExposed": False,
        ...
        "ruleCacheRestorePathsExposed": False,
        "stagedFilePolicyPreviewAvailable": True,
        "stagedFilePolicyTargetCount": 2,
        "stagedFilePolicyManagedTargetCount": 2,
        "stagedFilePolicyCacheHitTargetCount": 1,
        "stagedFilePolicyCacheMissTargetCount": 1,
        ...
        "finalOutputPromotionTargetCount": 1,
        "finalOutputPromotionCandidateOutputCount": 1,
        "finalOutputPromotionPromotedCount": 1,
        "finalOutputPromotionPendingCount": 0,
        "finalOutputPromotionPathsExposed": False,
        "finalOutputPromotionStorageUrisExposed": False,
    }
