...
def test_database_routes_delegate_request_dumping_to_service() -> None:
    ...
    assert "def scan_database_pack_ready_from_request(" in service_source
...
def test_ssh_routes_delegate_request_dumping_and_cache_to_service() -> None:
    ...
    assert "run_server_runner_uninstall_from_request" in ssh_routes
    ...
    assert "def run_server_runner_uninstall_from_request(" in service_source
