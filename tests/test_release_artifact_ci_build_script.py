...
def test_ci_builder_uses_controlled_linux_builder_not_ssh(monkeypatch) -> None:
    ...
    assert "CORE_RUNTIME_HELPER_FILES = runner_builder.CORE_RUNTIME_HELPER_FILES" in source
    assert "runner_builder.validate_built_remote_runner_candidate(" in source
