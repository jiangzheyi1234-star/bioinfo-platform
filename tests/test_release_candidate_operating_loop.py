...
def test_release_candidate_operating_loop_doc_defines_handoff_contract() -> None:
    ...
    for token in (
        ...
        "firstRunPilotCompletionProofAccepted: true",
        "persisted completion-proof",
        "handoffProof.completionProof.savedAt",
        "handoffProof.completionProof.validationCardJsonSha256",
        "handoffProof.completionProof.evidenceBundleZipFileRoles",
...
def test_release_candidate_script_collects_required_evidence_gates() -> None:
    ...
    for token in (
        ...
        "Test-FirstRunCompletionProof",
        "Convert-ToProofUtcTimestamp",
        "firstRunPilotTimingProofAccepted",
        "firstRunPilotCompletionProofAccepted",
        "h2ometa.first-run.timing-proof.v1",
        "h2ometa.first-run.completion-proof.v1",
        "$savedAt -ge $generatedAt",
        "$firstRunPilotTimingProofAccepted",
        "$firstRunPilotCompletionProofAccepted",
